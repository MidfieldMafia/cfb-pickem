...
/**
 * `SECTION_LABEL`'s twin for a pine surface: rust does not read on pine, so
 * it takes the surface's own ink, knocked back to 85%.
 */
export const PINE_LABEL = "text-xs font-bold uppercase tracking-[0.08em] opacity-85";
